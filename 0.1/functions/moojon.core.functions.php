...
function __autoload($class_name) {
	...
	} elseif (file_exists(moojon_paths::get_models_directory().$class_filename) == true) {
		require_once(moojon_paths::get_models_directory().$class_filename);
	} elseif (file_exists(moojon_paths::get_base_models_directory().$class_filename) == true) {
		require_once(moojon_paths::get_base_models_directory().$class_filename);
	} else {
