...
abstract class base_schema_migration extends moojon_base_model {
	...
	final static public function read_all_by_version($value, $order = null, $limit = null) {return self::read_by(get_class(), 'name', $value, $order, $limit);}
	final static public function read_by_version($value, $order = null, $limit = null) {return self::read_all_by_name($value, $order, $limit)->first;}
	final static public function destroy_by_version($value) {self::destroy_by(get_class(), 'name', $value);}
	final static public function read_or_create_by_version($value, $data = null) {return self::read_or_create_by(get_class(), 'name', $value, $data);}
