...
final class car_users_controller extends moojon_base_controller {
	...
	public function show() {
		$this->car_user = car_user::read_by_id(moojon_uri::get('id'));
	}
	...
	public function create() {
		$this->car_user = car_user::create(moojon_post::get('car_user'));
	...
	public function update() {
		$columns = moojon_post::get('car_user');
	...
	public function destroy() {
		$car_user = car_user::read_by_id(moojon_uri::get('id'));
		$car_user->delete();
