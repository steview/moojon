<?php
abstract class base_car_user extends moojon_base_model {
	
	protected function add_columns() {
		$this->add_primary_key();
		$this->add_string('car_id', 255, false, null);
		$this->add_string('user_id', 255, false, null);
	...
	final static public function read_all_by_car_id($value, $order = null, $limit = null) {return self::read_by(get_class(), 'car_id', $value, $order, $limit);}
	...
	final static public function read_by_car_id($value, $order = null, $limit = null) {return self::read_all_by_car_id($value, $order, $limit)->first;}
	...
	final static public function destroy_by_car_id($value) {self::destroy_by(get_class(), 'car_id', $value);}
	...
	final static public function read_or_create_by_car_id($value, $data = null) {return self::read_or_create_by(get_class(), 'car_id', $value, $data);}
