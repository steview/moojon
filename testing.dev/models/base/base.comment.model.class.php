<?php
abstract class base_comment extends moojon_base_model {
	...
	protected function add_columns() {
		...
		$this->add_integer('post_id', 11, false, null);
	...
	final static public function read_all_by_post_id($value, $order = null, $limit = null) {return self::read_by(get_class(), 'post_id', $value, $order, $limit);}
	...
	final static public function read_by_post_id($value, $order = null, $limit = null) {return self::read_all_by_post_id($value, $order, $limit)->first;}
	...
	final static public function destroy_by_post_id($value) {self::destroy_by(get_class(), 'post_id', $value);}
	...
	final static public function read_or_create_by_post_id($value, $data = null) {return self::read_or_create_by(get_class(), 'post_id', $value, $data);}
